...
function PeopleIcon({ x, y, size = 38, color }) {
  ...
  return (
    <g transform={`translate(${x - size / 2}, ${y - size * 0.45}) scale(${s})`}>
      ...
      <path fill="none" stroke={color} strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" d="M73.68,27.04c-3.56-.37-9.88-1.25-10.1-3.26-.08-.77.76-1.87,5.91-4.23,13.7-6.27,32.44-7.09,46.92-1.8,1.39.51,13.16,4.4,12.73,7.22-.24,1.57-4.14,2.29-7.46,2.65" />
      <path fill="none" stroke={color} strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" d="M79.62,14.73c1.26-4.93,3.11-12.59,8.92-13.43,3.1-.36,7.65.4,11.18,0,3.73-.28,6.69-.78,8.54.8,3.41,3.28,4.13,8.63,5.06,13.06" />
      <path fill="none" stroke={color} strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" d="M165.73,130.28c1.2-4.06,2.4-8.11,3.6-12.17,6-10.87,11.99-21.74,17.99-32.6,2.15-3.51,5.43-4.67,6.74-3.83,1.27.82,1.57,4.1-.4,7.4-5.7,10.47-11.4,20.95-17.1,31.42-3.73,3.6-7.46,7.2-11.19,10.81-1.77-3.48-5.39-9.32-12.12-13.76-14.64-9.66-31.26-4.33-33.62-3.53,6.08-11.9,12.16-23.8,18.24-35.69.54-.99,2.17-3.65,5.42-4.96,2.94-1.18,5.78-.53,7.57-.12,4.23.96,7.18,3.25,8.81,4.79,1.67-.78,5.33-2.19,10.02-1.69,6.88.74,11.08,5.11,12.16,6.3,1.24-1.81,2.52-4.33,1.7-6.52-.58-1.54-1.51-2.7-5.18-4.14-2.99-1.17-5.81-2.79-7.23-5.75-2.16-3.67-.67-7.23,1.31-10.78,1.95-4.05,3.86-8.77,2.56-13.27-.86-2.96-3.41-5.44-5.99-6.57-10.37-4.57-21.69,12.57-35.55,9.2-3.86-.94-6.67-3.16-8.42-4.87" />
      <path fill="none" stroke={color} strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" d="M155.17,61.77c-6.93-2.21-12.89-10.03-12.94-17.76-.41-8.07,2.3-16.75,9.29-21.33,7.93-5.02,18.49-2.51,24.02,4.8,5.98,7.26,4.66,19.42.74,26.43" />
      <path fill="none" stroke={color} strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" d="M9.13,24.11c1.26,3.17,3.44,7.03,7.33,8.58,4.59,1.83,7.67-1.08,14.66-1.79,1.15-.12,16.06-1.44,21.46,6.97,4.19,6.53.42,15.42-.36,17.17" />
    </g>
  )
}
